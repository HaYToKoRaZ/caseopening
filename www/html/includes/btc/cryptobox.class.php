...
class Cryptobox {
	...
	public function __construct($options = array())
	{
		...
		if (isset($_GET[$id]) && in_array($_GET[$id], array_keys($this->localisation))) $this->language = "en";
		elseif (isset($_COOKIE[$id]) && in_array($_COOKIE[$id], array_keys($this->localisation))) $this->language = "en";
	...
	*/
	public function display_cryptobox($submit_btn = true, $width = "540", $height = "230", $box_style = "", $message_style = "", $anchor = "")
	{
		...
		$hash = md5($hash_str);
		$cryptobox_html .= "<iframe id='$this->iframeID' style='width:100%;' scrolling='no' marginheight='0' marginwidth='0' frameborder='0' width='$width' height='$height'></iframe>";
		$cryptobox_html .= "<script type='text/javascript'>cryptobox_show($this->boxID, '$this->coinName', '$this->public_key', $this->amount, $this->amountUSD, '$this->period', '$this->language', '$this->iframeID', '$this->userID', '$this->userFormat', '$this->orderID', '$this->cookieName', '$this->webdev_key', '$hash', $width, $height);</script>";
